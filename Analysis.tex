...
10^{-2}$}{\GeV}$^{-1}$ obtained from region $B$ is used as the central value of the 
...
\unit{1.13~$\pm$~0.26~$\times~10^{-2}$}{\GeV}$^{-1}$, the relative error on this 
...
\unit{-2.96~$\pm$~0.61(stat)~$\pm$~0.46(sys)~$\times~10^{-2}$}{\GeV}$^{-1}$. The 
