\chapter{The \texorpdfstring{$\alpha_{T}$} analysis} % (fold)
...
Figures~\ref{fig:cmssm-dead-ecal},~\ref{fig:sms-dead-ecal-ineff}~and~\ref{fig:sm
s-dead-ecal-near} show the relative change in efficiency due to the 
...
\paragraph{Declaration} % (fold)
\label{par:declaration}
The likelihood model was implemented, developed, commissioned and deployed in anger by Edward Laird and is best described in his thesis\cite{ted}. However for completeness the likelihood model is described in this section.
% paragraph declaration (end)
