...
rotational curves of the M33 galaxy\mcite{Corbelli1999af} show that the amount 
...
\caption{ M33 rotation curve (points) compared with the best fit model
          ...
          (long dashed line) \mcite{Corbelli1999af}.
          }
...
\begin{figure}[ht]
  ...
  \caption{Production cross sections at \ac{lhc} design conditions for \ac{sm} processes, Higgs production for various Higgs masses and \ac{susy} production cross sections. Output rate is also shown as are the hardware limits due to the \Lone trigger and the High Level Trigger\mcite{productionxsecs}. }
...
ATLAS\mcite{ref:atlas} and \ac{cms}\mcite{ref:cms} the latter of which is 
described in detail in Chapter~\ref{cha:the_cms_detector}. The other two 
detectors are specialised. LHCb\mcite{ref:lhcb} is designed to study 
charge-parity violation in the \Pbottom sector and perform precision 
measurements of the \ac{sm}. The ALICE\mcite{ref:alice} experiment is designed to 
...
% The (\ac{lhc}) \mcite{Benedikt:823808} is a proton-proton collider which is situated in the Large Electron Positron
...
% 
% Situated around the \ac{lhc} ring are four detectors, two general detectors ATLAS \mcite{Akesson:1999uv} and CMS (see
% Chapter~\ref{cha:the_cms_detector} for a detailed discussion of the CMS detector) \mcite{Friedl:1140134}\mcite{Wulz:vf} which are  designed to measure the \ac{sm} to high precision and search for new physics. The \ac{lhc} beauty experiment 
% \mcite{Rademacker:2005tx} is designed to study at previously unattainable precision the decays of heavy quark 
% flavors, both to measure the \ac{sm} couplings and to search for beyond the \ac{sm} (BSM) physical processes. Finally
% the ALICE \mcite{Alessandro:2006ht} experiment is designed to run when the \ac{lhc} is running in it's secondary mode where rather than
