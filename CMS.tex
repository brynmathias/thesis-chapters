...
containing muons and the ``golden'' Higgs decay channel
\HepProcess{\PH\to\PZ\PZ\to\Pmu\Pmu\Pmu\Pmu}, the detector was designed to 
accurately reconstruct muons with \PT of \unit{1}{\TeV}. Due to the 
...
\unit{2.5}{\meter}. At the \ac{lhc}'s design instantaneous luminosity of \unit{10$^{34}$}{\lumiunits} an average of 1000 charged particles from more 
