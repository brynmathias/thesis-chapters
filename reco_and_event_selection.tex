% \chapter{An all hadronic search for Supersymmetry at the LHC} % (fold)
% \label{cha:an_all_hadronic_search_for_supersymmetry_at_the_lhc}
% The subsequent chapters describe a search for \ac{susy} in exclusivly hadronic final


% chapter an_all_hadronic_search_for_supersymmetry_at_the_lhc (end)
...
used in the analysis presented in \mcite{Chatrchyan:2012wa}.
...
algorithm with a clustering parameter of 0.5\mcite{Cacciari:2008ua}, for high \PT jets this produces cone like jets, for low \PT jets deviations from the circular geometry are allowed, as show in Figure~\ref{fig:figures_Analysis_ak5algo}.
...
2$\%$ and 4$\%$ dependent  on \ET and $\eta$\mcite{Chatrchyan:2011ds}. 
...
\begin{figure}[htbp]
  ...
  \caption{Absolute jet energy scale uncertainty as a function of jet \PT for \AK-calorimeter jets\mcite{1748-0221-6-11-P11002}.}
...
starts by creating superclusters\mcite{0954-3899-34-6-S01} which contain 
...
Filter\mcite{0954-3899-31-9-N01}.
For the purpose of the analysis an object is defined as an electron if it has 
\PT $>$ \unit{10}{\GeV}, \mETA $<$ 2.5 and passes standard criteria for $95\%$ selection efficiency\mcite{PAS-EGM-10-004}. Any event containing an identified 
electron is vetoed. 
% paragraph electrons (end)
...
\begin{figure}[htbp]
  ...
  \caption{Resolution of (1/p) versus p for standalone, global and tracker-only reconstruction. a) Barrel, $\eta$ = 0.5; b) Endcap, $\eta$ = 1.5.\mcite{0954-3899-34-6-S01}}
...
identification that gives $95\%$ selection efficiency\mcite{PAS-MUO-10-002}. Two 
...
% subsection cross_cleaning (end)

\section{The \alt variable} % (fold)
\label{sec:the_alpha___t_variable_}
The \alt is variable inspired by Ref~\mcite{Randall:2008dk} and was expanded first to consider transverse topologies and later expanded to  multi-jet systems by members of the CMS collaboration in  Refs~\mcite{cms-pas-sus-08005,cms-pas-sus-09001}. The purpose is to provide variable that can be used to reduce the fraction of QCD from the final event selection. To do this the balance of the QCD system is exploited.
...
For a perfectly measured di-jet system with $E_{T}^{j_{1}} = E_{T}^{j_{2}}$ and 
...
% However the raw number of events in the signal region is meaningless without 
...
\begin{figure}[|h]
  \centering
  \subfigure[ HLT$\_$HT250$\_$AlphaT0p55$\_$v1\label{fig:figures_Analysis_HT275_HLT_HT250_AlphaT0p55_v1_HLT_Mu5_HT200_v4}]{ \includegraphics[width=0.4\textwidth]{figures/Analysis/HT275_HLT_HT250_AlphaT0p55_v1_HLT_Mu5_HT200_v4.pdf}
  } 
  \subfigure[ HLT$\_$HT250$\_$AlphaT0p53$\_$v2\label{fig:figures_Analysis_HT275_HLT_HT250_AlphaT0p53_v2_HLT_Mu15_HT200_v2}]{
    \includegraphics[width=0.4\textwidth]{figures/Analysis/HT275_HLT_HT250_AlphaT0p53_v2_HLT_Mu15_HT200_v2.pdf}
  } \\
  \subfigure[HLT$\_$HT250$\_$AlphaT0p53$\_$v3\label{fig:figures_Analysis_HT275_HLT_HT250_AlphaT0p53_v3_HLT_Mu15_HT200_v3}]{
    \includegraphics[width=0.4\textwidth]{figures/Analysis/HT275_HLT_HT250_AlphaT0p53_v3_HLT_Mu15_HT200_v3.pdf}
  } 
  \subfigure[HLT$\_$HT250$\_$AlphaT0p53$\_$v4\label{fig:figures_Analysis_HT275_HLT_HT250_AlphaT0p53_v4_HLT_Mu15_HT200_v4}]{    \includegraphics[width=0.4\textwidth]{figures/Analysis/HT275_HLT_HT250_AlphaT0p53_v4_HLT_Mu15_HT200_v4.pdf}
  } 
  \\
  \subfigure[ HLT$\_$HT250$\_$AlphaT0p53$\_$v5\label{fig:figures_Analysis_HT275_HLT_HT250_AlphaT0p53_v5_HLT_Mu30_HT200_v1}]{ \includegraphics[width=0.4\textwidth]{figures/Analysis/HT275_HLT_HT250_AlphaT0p53_v5_HLT_Mu30_HT200_v1.pdf}
  } 
  \subfigure[HLT$\_$HT250$\_$AlphaT0p58$\_$v3\label{fig:figures_Analysis_DiMu_HT275_HLT_HT250_AlphaT0p58_v3_HLT_DoubleMu8_Mass8_HT200_v4}]{ \includegraphics[width=0.4\textwidth]{figures/Analysis/DiMu_HT275_HLT_HT250_AlphaT0p58_v3_HLT_DoubleMu8_Mass8_HT200_v4.pdf}
  }
  \\
  \subfigure[HLT$\_$HT250$\_$AlphaT0p58$\_$v3\label{fig:figures_Analysis_DiMu_HT275_HLT_HT250_AlphaT0p58_v3_HLT_DoubleMu8_Mass8_HT200_v5}]{
    \includegraphics[width=0.4\textwidth]{figures/Analysis/DiMu_HT275_HLT_HT250_AlphaT0p58_v3_HLT_DoubleMu8_Mass8_HT200_v5.pdf}
  } 
  \subfigure[HLT$\_$HT250$\_$AlphaT0p60$\_$v3\label{fig:figures_Analysis_DiMu_HT275_HLT_HT250_AlphaT0p60_v3_HLT_DoubleMu8_Mass8_HT200_v4}]{    \includegraphics[width=0.4\textwidth]{figures/Analysis/DiMu_HT275_HLT_HT250_AlphaT0p60_v3_HLT_DoubleMu8_Mass8_HT200_v4.pdf}
  }
...
\begin{figure}[|h]
  \centering  \subfigure[HLT$\_$HT250$\_$AlphaT0p60$\_$v3\label{fig:figures_Analysis_HT275_HLT_HT250_AlphaT0p55_v2_HLT_Mu40_HT200_v4}]{    \includegraphics[width=0.4\textwidth]{figures/Analysis/HT275_HLT_HT250_AlphaT0p55_v2_HLT_Mu40_HT200_v4.pdf}
  }   
...
The second upgrade was to switch to \pu corrected jets at the HLT, this 
...
measured for the analysis documented in \mcite{CMS-PAS-SUS-12-028}. A 
...
\begin{figure}[|h]
  \centering
  \subfigure[HLT$\_$HT250$\_$AlphaT0p55$\_$v1\label{fig:figures_Analysis_8TeVTriggers_HT275_HLT_HT250_AlphaT0p55_v1_HLT_IsoMu24_eta2p1_v11}]{ \includegraphics[width=0.4\textwidth]{figures/Analysis/8TeVTriggers/HT275_HLT_HT250_AlphaT0p55_v1_HLT_IsoMu24_eta2p1_v11.pdf}
  } 
  \subfigure[HLT$\_$HT250$\_$AlphaT0p55$\_$v2\label{fig:figures_Analysis_8TeVTriggers_HT275_HLT_HT250_AlphaT0p55_v2_HLT_IsoMu24_eta2p1_v12}]{ \includegraphics[width=0.4\textwidth]{figures/Analysis/8TeVTriggers/HT275_HLT_HT250_AlphaT0p55_v2_HLT_IsoMu24_eta2p1_v12.pdf}
  } \\
  \subfigure[HLT$\_$HT250$\_$AlphaT0p55$\_$v3\label{fig:figures_Analysis_8TeVTriggers_HT275_HLT_HT250_AlphaT0p55_v3_HLT_IsoMu24_eta2p1_v12}]{ \includegraphics[width=0.4\textwidth]{figures/Analysis/8TeVTriggers/HT275_HLT_HT250_AlphaT0p55_v3_HLT_IsoMu24_eta2p1_v12.pdf}
  } 
  \subfigure[HLT$\_$HT250$\_$AlphaT0p55$\_$v4\label{fig:figures_Analysis_8TeVTriggers_HT275_HLT_HT250_AlphaT0p55_v4_HLT_IsoMu24_v15}]{ \includegraphics[width=0.4\textwidth]{figures/Analysis/8TeVTriggers/HT275_HLT_HT250_AlphaT0p55_v4_HLT_IsoMu24_v15.pdf}
  } 
\caption{Turn on curves for the individual \alt triggers used to seed the 
...
\section{Including B-tagging in the \alt analysis.} % (fold)
