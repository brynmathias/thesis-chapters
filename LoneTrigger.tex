...
\section{Level-1 Trigger Jet Algorithm \cite{gctcomm}} % (fold)
...
corrected for pile up using the fastjet correction algorithm, \todo[inline]{cite fast jet} which is further detailed in Section~\ref{sub:Preselection_of_hadronic_objects}.
