...
HLT$\_$IsoMu24, this removes any biases on the turn on from pre selecting with 
a hadronic trigger. To test the performance of the trigger system under high 
pile up conditions ($<PU> ~ \leq ~ 32$) a dedicated high pile up fill of the 
LHC was performed.The high pile up fill is studied from two points of view, the 
first is with regard to standard AK5 calorimeter jets. Secondly the performance 
is measured against AK5 calorimeter jets that are corrected for pile up.
...
\begin{figure}[ht]
  ...
  offline corrected AK5 calorimeter jet \ET.}
...
\begin{figure}[ht]
  ...
  offline corrected AK5 calorimeter jet \ET in high pile up conditions.}
...
\begin{figure}[ht]
  ...
  \caption{Turn on curves for the three \Lone single jet triggers in terms of 
  offline AK5 calorimeter jets where the energies are corrected for energy from 
...
Trigger & $\sigma$ & $\mu$\\
\hline
L1$\_$SingleJet16 & 7.482639 & 24.273190 \\
\hline
L1$\_$SingleJet36 & 6.078462 & 49.253546 \\
\hline
L1$\_$SingleJet52 & 6.751985 & 65.108612 \\
\hline
\end{tabular}
...
Trigger & $\sigma$ & $\mu$\\
\hline
L1$\_$SingleJet16 & 6.367845 & 10.475396 \\
\hline
L1$\_$SingleJet36 & 6.345340 & 40.733543 \\
\hline
L1$\_$SingleJet52 & 6.649299 & 57.481793 \\
\hline
\end{tabular}
\caption{Results of an error function fit to the turn on curves for \Lone 
...
Trigger & $\sigma$ & $\mu$\\
\hline
L1$\_$SingleJet16 & 6.067393 & 15.193586 \\
\hline
L1$\_$SingleJet36 & 7.047272 & 47.770072 \\
\hline
L1$\_$SingleJet52 & 6.744601 & 63.676276 \\
\hline
\end{tabular}
\caption{Results of an error function fit to the turn on curves for \Lone 
