...
corrected for pile up using the fastjet correction algorithm, \todo[inline]{cite fast jet} which is further detailed in Section~\ref{cha:offline_object_deffinitions}.
